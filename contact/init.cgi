...
my %cf;
#┌─────────────────────────────────
#│ CLIP-MAIL : init.cgi - 2017/03/20
#│ copyright (c) kentweb, 1997-2017
#│ http://www.kent-web.com/
#└─────────────────────────────────
$cf{version} = 'clipmail v6.0';
#┌─────────────────────────────────
#│ [注意事項]
...
$cf{extension} = "gif,jpg,jpeg,png,tif,tiff,doc,docx,xls,xlsx,pdf,ppt,pptx,txt";
...
# 返信向けメールタイトル
$cf{sub_reply} = '【寿永堂】お問い合わせありがとうございます';
