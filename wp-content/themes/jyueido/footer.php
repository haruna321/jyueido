...
<?php else : ?>
    <div id="footer-banner">
        ...
        <div class="Bnr" id="footer-contact">
            <div class="Bnr__img">
                <p class="close c_button"><a href="javascript:void(0)"><span>閉じる</span><i aria-hidden="true" class="fa fa-times"></i></a></p>
                <div class="Bnr__img__inner">
                    <div class="frame noneSp noneTab">
                        ...
                        <div class="line"><a href="https://lin.ee/NlNE9Ia">友達追加</a></div>
                    </div>
                    <!-- /.Bnr__img__inner -->
                </div>
                <!-- /.Bnr__img -->
...
<div class="container pos-r">
    ...
    <p class="footer-logo"><a href="<?php echo $site_url; ?>/"><img src="<?php echo $site_url; ?>/img/common/logo.svg" alt="古美術 寿永堂（じゅえいどう）"></a>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 g-b">
            <div class="row text-center g-b-25">
                <div class="col-xs-12 col-md-6"><a href="<?php echo $site_url; ?>/staffblog/" class="btn-100 btn-arrow-circle-2 min-w-init w-100p g-b-10 fz-13">寿永堂 Blog</a></div>
                <div class="col-xs-12 col-md-6"><a href="http://www.jewelry-jyueidou.com/" class="btn-100 btn-arrow-circle-2 min-w-init w-100p g-b-10 fz-13" target="_blank">Jewelry Jyueido</a></div>
            </div>
        ...
        <div class="col-xs-12 col-sm-6 g-b g-xs-b-0 p-xs-0" id="footer-area">
            <div class="bg-gs-15 p-30">
                <div class="row text-lh-1_5">
                    ...
                    <div class="col-xs-12 col-md-6">
                        <p><img src="<?php echo $site_url; ?>/img/common/placeholder_872x612.png" data-src="<?php echo $site_url; ?>/img/common/areamap.png" class="img-responsive lazyload" alt=""></p>
                    </div>
                </div>
...
<div class="copyright-container">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 text-left text-xs-center"><a href="http://www.police.pref.hyogo.lg.jp/sc/second.htm" target="_blank">兵庫県公安委員会許可 第631100700042号</a></div>
