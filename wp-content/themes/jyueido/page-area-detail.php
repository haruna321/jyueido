...
<p class="title-5 g-b-0"><img src="<?php echo $cfs->get('mv'); ?>" alt=""></p>
    ...
    <div class="box add_mb20">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-lg-5 g-b-20">
          <img src="<?php echo $cfs->get('prefectures-img'); ?>" class="img-responsive lazyload" alt="">
        </div>
...
<div class="about-wrap">
  <div class="votb">
    ...
    ただ実際、「骨董品」は希少価値のある、且つ古くに作られたものを指す言葉なので絵画や掛軸、陶芸など物品のジャンルを問わず、希少価値のある古くに作成されたものであれば「骨董品」と呼ばれ、種類は多岐にわたります。<br>
    <br>
    <h3>骨董品の世界的な定義</h3>
    ...
    <br>
    また、骨董品は「美術工芸品」「民芸品」の２つに大別されます。<br>
    <br>
    <h3>「美術工芸品」（古美術品）</h3>
    骨董品より美的鑑賞に重きを置いた作品のことをいい、<br>
    主に床の間に置く飾道具やお茶道具・書道具・煎茶道具・香道具・花道具があります。<br>

    <h3>「民芸品」（古道具）</h3>
    机や椅子、箪笥などの家具や欄間などの建具のほか、生活に使われていたお皿や器、グラスなどの生活用品があります。<br>
  </div>
</div>
...
<div id="area-city">
  <div class="container">
    <div class="bg-gs-15 p-20 p-xs-0 g-b">
      ...
      <?php if (get_post_meta($post->ID, 'station', true)) : ?>
        <div class="box-a">
