...
<body id="<?php echo $body_id; ?>">
  ...
  <header class="site-header" id="site-header">
    <div class="header-inner">
      <p class="header-logo"><a href="<?php echo $site_url; ?>/"><img src="<?php echo $site_url; ?>/img/common/logo.svg"
  ...
  <div class="home-main-wrap">
    ...
    <div class="home-main-container-2 hidden-xs text-center bg-gs-3">
      <img src="./img/common/placeholder_1200x680.png" data-src="./img/home/main/main.jpg"
        class="img-responsive lazyload" alt="">
    </div>

    <div class="home-main-container-sp visible-xs text-center">
      <div class="home-main-1-sp"><img src="./img/common/placeholder_908x720.png" data-src="./img/home/main/1.jpg"
          class="img-responsive lazyload" alt=""></div>
    </div>
  </div>
    ...
    <div class="global-nav-inner">
      ...
      <nav class="global-nav">
        ...
        <div class="global-nav-sp text-center">
          ...
          <a href="tel:0120-13-6767" class="tel g-t-20"><img src="<?php echo $site_url; ?>/img/common/tel.svg"
              alt=""></a>
